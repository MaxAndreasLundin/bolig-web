  ...
  return (
    <div className="bg-white flex flex-col items-center justify-center h-[90vh]">
      ...
      <p className="text-black">
        Inget konto? Skapa ett konto genom att{" "}
        <Link href={"registration"}>
          <span className="underline cursor-pointer">klicka här!</span>
        </Link>
      </p>
      <p className="text-blue-500 text-xs pt-2">Glömt lössenord, klicka här.</p>
    </div>
  );
};
