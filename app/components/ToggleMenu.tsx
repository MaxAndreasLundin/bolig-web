...
const ToggleMenu = () => {
  ...
  return (
    <>
      ...
      <ul className={click ? "bg-blue-900 flex flex-col w-[100%] h-[90vh] absolute top-16 right-0 transition-all duration-500 z-10" : "flex flex-col w-[100%] h-[90vh] absolute top-20 -right-full transition- duration-500"}>
